...
To do this, I will perform two types of features selection:
...
We are now going to combine these models.
...
A first conclusion leads me to confirm that the model that performs best in terms of results and interpretability is the 'Best_model' ????????? model.
It allows me to understand which parameters are most important for understanding passenger satisfaction as previously mentioned.
